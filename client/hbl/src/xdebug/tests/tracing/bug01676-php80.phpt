...
%w%f %w%d     -> xdebug_get_tracefile_name() %sbug01676-php80.php:17
%w%f %w%d     -> register_shutdown_function($callback = 'shutdown') %sbug01676-php80.php:19
%w%f %w%d     -> var_dump($value = 'foo') %sbug01676-php80.php:20
