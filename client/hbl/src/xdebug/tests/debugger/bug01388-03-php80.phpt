--TEST--
Test for bug #1388: Resolved Breakpoint: resolved to changed line (method) (>= PHP 8.0)
--SKIPIF--
<?php
...
<?xml version="1.0" encoding="iso-8859-1"?>
<notify xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" name="breakpoint_resolved"><breakpoint type="line" resolved="resolved" filename="file://bug01388-03.inc" lineno="5" state="enabled" hit_count="0" hit_value="0" id=""></breakpoint></notify>
...
<?xml version="1.0" encoding="iso-8859-1"?>
<notify xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" name="breakpoint_resolved"><breakpoint type="line" resolved="resolved" filename="file://bug01388-03.inc" lineno="13" state="enabled" hit_count="0" hit_value="0" id=""></breakpoint></notify>
