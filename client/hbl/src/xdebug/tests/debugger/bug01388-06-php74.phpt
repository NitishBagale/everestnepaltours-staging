--TEST--
Test for bug #1388: Resolved Breakpoint: resolved to changed line (WI-2898) (< PHP 8.0)
--SKIPIF--
<?php
...
-> breakpoint_set -i 3 -t line -f file://bug01388-06.inc -n 2
<?xml version="1.0" encoding="iso-8859-1"?>
<notify xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" name="breakpoint_resolved"><breakpoint type="line" resolved="resolved" filename="file://bug01388-06.inc" lineno="3" state="enabled" hit_count="0" hit_value="0" id=""></breakpoint></notify>
...
-> run -i 4
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" command="run" transaction_id="4" status="break" reason="ok"><xdebug:message filename="file://bug01388-06.inc" lineno="3"></xdebug:message></response>
