--TEST--
Test for bug #1388: Resolved Breakpoint in a closure (< PHP 8.0)
--SKIPIF--
<?php
...
-> breakpoint_set -i 3 -t line -f file://bug01388-09.inc -n 4
<?xml version="1.0" encoding="iso-8859-1"?>
<notify xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" name="breakpoint_resolved"><breakpoint type="line" resolved="resolved" filename="file://bug01388-09.inc" lineno="5" state="enabled" hit_count="0" hit_value="0" id=""></breakpoint></notify>
...
-> step_into -i 6
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" command="step_into" transaction_id="6" status="break" reason="ok"><xdebug:message filename="file://bug01388-09.inc" lineno="5"></xdebug:message></response>

-> stack_get -i 7
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" command="stack_get" transaction_id="7"><stack where="{closure:%sbug01388-09.inc:2-8}" level="0" type="file" filename="file://bug01388-09.inc" lineno="5"></stack><stack where="{main}" level="1" type="file" filename="file://bug01388-09.inc" lineno="10"></stack></response>
