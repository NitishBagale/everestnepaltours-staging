...
-> step_into -i 3
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" command="step_into" transaction_id="3" status="break" reason="ok"><xdebug:message filename="file://bug01388-18.inc" lineno="3"></xdebug:message></response>

-> breakpoint_set -i 4 -t line -n 2
<?xml version="1.0" encoding="iso-8859-1"?>
