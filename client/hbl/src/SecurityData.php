...
class SecurityData
{
	...
	public static string $MerchantId = "9103335451";
    /**
     * JWE Key Id.
     *
     * @var string
	...
	public static string $AccessToken = "741653d4d7f1451c9e82a1ec32a6670a";// Everest Nepal Tours HBL API key
